...
def render_time_series_plot_with_histogram(
    ...
    render_multiple_time_series_plot(
        ...
        title=title,
        subtitles=None,
        xtitles=[xtitle] if xtitle else None,
        xunits=[xunit] if xunit else None,
        ytitles=[ytitle] if ytitle else None,
        yunits=[yunit] if yunit else None,
        x_ranges=[x_range] if x_range else None,
        y_ranges=[y_range] if y_range else None,
        outpath=outpath,
        outputext=outputext,
